...
public class Exercise4Test {
    ...
    public void zonedDateTimeFormat() {
         ...
         */
        String strZdt = zdt.format(DateTimeFormatter.ofPattern("yyy_MM_dd_HH_mm_ss_z"));//jak tu działa z? skąd wie że to JST?
    ...
    public void sameLocalAs() {
         ...
         */
        ZonedDateTime zonedDateTime = zdt.withZoneSameLocal(ZoneId.of("America/Los_Angeles"));//różnica w działaniu między tym, a przykłdem wyżej
