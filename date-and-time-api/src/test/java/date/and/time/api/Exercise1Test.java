...
public class Exercise1Test {
    ...
    public void localDateWith() {
         ...
         */
        LocalDate localDate = ld.withYear(2015).withMonth(6).withDayOfMonth(18);
//        LocalDate localDate = ld.with(Year.of(2015)).with(Month.JUNE).withDayOfMonth(18);
    ...
    public void localDatePlus() {
         ...
         */
//        LocalDate localDate = ld.plusMonths(10L);
        LocalDate localDate = ld.plus(10L, ChronoUnit.MONTHS);
    ...
    public void localDateMinus() {
         ...
         */
//        LocalDate localDate = ld.minusDays(10L);
        LocalDate localDate = ld.minus(10L, ChronoUnit.DAYS);
