 ...
 */
        ...
        BiConsumer<StringJoiner, String> accumulator = (x, y) -> x.add(y);
        BinaryOperator<StringJoiner> combiner = null;
        Function<StringJoiner, String> finisher = x -> x.toString();
 ...
 */
        ...
        BiConsumer<Map<String, Set<String>>, Customer> accumulator = (x, y) ->
                x.put(y.getWantToBuy()
                                .stream()
