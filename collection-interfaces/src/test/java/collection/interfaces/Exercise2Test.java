...
public class Exercise2Test {
    ...
    public void mergeValues() {
         ...
         */
        BiFunction<Integer, Integer, Integer> remappingFunction = (x,y) -> x + y;
    ...
    public void ignoringAbsentKeys() {
         ...
         */
        BiFunction<String, Integer, Integer> remappingFunction = (k,v) -> v + 1 ;// czemu tu ten BiFunction działa inaczej niż wyżej?
